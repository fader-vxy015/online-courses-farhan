...
<div class="auth-wrapper">
  <div class="auth-container">
    ...
    <div class="auth-panel">
      ...
      <p>Masuk ke akun Anda untuk melanjutkan perjalanan belajar dan akses semua kursus favorit Anda.</p>
      <div class="benefits">
        ...
        <div class="benefit-item">
          <i class="fas fa-check"></i>
          <span>Lacak progres belajar Anda</span>
        </div>
        <div class="benefit-item">
          <i class="fas fa-check"></i>
    ...
    <div class="auth-form-section">
      ...
      <p class="auth-footer-link">Belum punya akun? <a href="register.php">Daftar sekarang <i class="fas fa-arrow-right"></i></a></p>
    </div>
  </div>
</div>
